...
class Day11 : DayX {
    ...
    private fun flashOn(field: Day11.MyField, newToFlash: Set<Day11.MyFieldPos>, alreadyFlashed: Set<MyFieldPos>): Day11.MyField {
        ...
        return flashOn(newField, newField.getPos { v: Int -> v > 9 } - newToFlash - alreadyFlashed, alreadyFlashed + newToFlash)
    }
